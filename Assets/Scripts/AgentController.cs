...
public class AgentController : Agent
{
    ...
    {
        //Agent
        transform.localPosition = new Vector3(Random.Range(-48, 48f), 2.3f, Random.Range(-48f, 48f)); //will spawn it randomly on this position (the position is decided by the maze size)
